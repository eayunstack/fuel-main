...
MIRROR_CENTOS?=http://mirror.centos.org/centos/$(CENTOS_RELEASE)/os/x86_64
MIRROR_CENTOS_KERNEL?=http://mirror.centos.org/centos/$(CENTOS_RELEASE)/os/x86_64
MIRROR_CENTOS_OS_BASEURL:=$(MIRROR_CENTOS)
MIRROR_CENTOS_KERNEL_BASEURL?=$(MIRROR_CENTOS_KERNEL)
