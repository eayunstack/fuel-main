...
$(BUILD_DIR)/openstack/rpm/$1.done: \
	...
	sudo env "PATH=$${PATH}" chroot $$(SANDBOX) rpmbuild --nodeps -vv --define "_topdir /tmp" -bs /tmp/openstack-$1.spec
	...
	sudo env "PATH=$${PATH}" chroot $$(SANDBOX) rpmbuild --nodeps -vv --define "_topdir /tmp" -ba /tmp/openstack-$1.spec
